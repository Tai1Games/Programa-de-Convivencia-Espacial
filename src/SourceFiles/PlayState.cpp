...
void PlayState::init() {
	...
	Collider* collSuelo = ground->addComponent<Collider>(physicsWorld_, b2_staticBody, 10.5, -0.5, 12,1,	10,			0,			0.2,			0,				0,					Collider::CollisionLayer::Normal,	false,     false);
	...
	collTinky->applyLinearImpulse(b2Vec2(0, -100), b2Vec2(1, 1));
