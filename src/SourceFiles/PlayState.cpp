...
void PlayState::init() {
	...
	Collider* collTonko = tonko->addComponent<Collider>(physicsWorld_, b2_dynamicBody, 12, 2, 1, 1, 1, 0.1, 0.2, 0, 0, Collider::CollisionLayer::Player, false);
	...
	//Lo comento porque no tengo el mando
	...
	collTinky->applyLinearImpulse(b2Vec2(40, 10), b2Vec2(0.1, 0));
