...
void PlayState::init() {
	...
	Collider* collTinky = tinky->addComponent<Collider>(physicsWorld_, b2_dynamicBody, 2, 2, 1, 1,			1,			0.1,		0.2,			0,				0,					Collider::CollisionLayer::Normal,	false);
	...
	collTinky->applyLinearImpulse(b2Vec2(5, 0), b2Vec2(0, 0));
