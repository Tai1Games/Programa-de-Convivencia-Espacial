...
void PauseState::init()
{
	...
	pauseText->addComponent<UIViewer>(Resources::PauseText, b2Vec2((CONST(int, "WINDOW_WIDTH") / 2) - 250, (CONST(int, "WINDOW_HEIGHT") / 2) - 310), 2.5, 0);
	...
	musicSliderImage_ = musicSlider->addComponent<UIViewer>(Resources::Slider, b2Vec2(CONST(int, "WINDOW_WIDTH") - 700, btns_[Buttons::Music]->getPosUIElement().y), 2, 0);
	effectsSliderImage_ = effectsSlider->addComponent<UIViewer>(Resources::Slider, b2Vec2(CONST(int, "WINDOW_WIDTH") - 700, btns_[Buttons::Effects]->getPosUIElement().y), 2, 0);
