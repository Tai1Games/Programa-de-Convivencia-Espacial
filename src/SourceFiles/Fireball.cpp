...
void Fireball::setActive(bool to,b2Vec2 pos)
{
	...
	if (to) {
		col_->createCircularFixture(CONST(double, "COIN_BASE_SIZE"), CONST(double, "COIN_DENSITY"), CONST(double, "COIN_FRICTION"), CONST(double, "COIN_RESTITUTION"), Collider::CollisionLayer::NormalObject, false);
	}
